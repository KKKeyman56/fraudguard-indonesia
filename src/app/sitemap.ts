...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${siteUrl}/privacy`, lastModified: new Date("2026-07-30T00:00:00+07:00"), changeFrequency: "yearly", priority: 0.4 },
    { url: `${siteUrl}/terms`, lastModified: new Date("2026-07-30T00:00:00+07:00"), changeFrequency: "yearly", priority: 0.4 },
    { url: `${siteUrl}/data-deletion`, lastModified: new Date("2026-07-30T00:00:00+07:00"), changeFrequency: "yearly", priority: 0.4 },
